...
import com.example.suachuatranchauhalongg_shipper.Object.Voucher_Customer;
...
public class RequestRedeenPointAdapter extends RecyclerView.Adapter<RequestRedeenPointAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull RequestRedeenPointAdapter.ViewHolder holder, int position) {
        initReference();
